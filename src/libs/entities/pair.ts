...
export class Pair {
  ...
  /**
   * Create2 Ethereum Improvement Proposals EIP-1014
   * 获取pair对合约地址，Create2允许使用链上尚不存在但可以依赖的地址进行交互。
   * 地址由特定初始化代码及可控的salt控制。
   * @description https://eips.ethereum.org/EIPS/eip-1014
   */
  ...
  public constructor(tokenAmountA: TokenAmount, tokenAmountB: TokenAmount, FACTORY_ADDRESS: string, INIT_CODE_HASH: string) {
  ...
  public getOutputAmount(inputAmount: TokenAmount): [TokenAmount, Pair] {
    ...
    return [outputAmount, new Pair(inputReserve.add(inputAmount), outputReserve.subtract(outputAmount), this.FACTORY_ADDRESS, this.INIT_CODE_HASH)]
  }
  ...
  public getInputAmount(outputAmount: TokenAmount): [TokenAmount, Pair] {
    ...
    return [inputAmount, new Pair(inputReserve.add(inputAmount), outputReserve.subtract(outputAmount), this.FACTORY_ADDRESS, this.INIT_CODE_HASH )]
  }

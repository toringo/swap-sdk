...
export const mainnetTokens = defineTokens({
  ...
  ethk: new Token(ChainId.MAINNET, '0xef71ca2ee68f45b9ad6f72fbdb33d707b872315c', 18, 'ETHK', 'ETHK', 'https://www.okx.com/'),
  ...
  tlos: new Token(ChainId.MAINNET, '0xb6C53431608E626AC81a9776ac3e999c5556717c', 18, 'TLOS', 'Telos', 'https://www.telos.net/'),
  beta: new Token(
    ChainId.MAINNET,
  ...
  pros: new Token(ChainId.MAINNET, '0xEd8c8Aa8299C10f067496BB66f8cC7Fb338A3405', 18, 'PROS', 'Prosper', 'https://prosper.so/'),
  qbt: new Token(ChainId.MAINNET, '0x17B7163cf1Dbd286E262ddc68b553D899B93f526', 18, 'QBT', 'Qubit Token', 'https://qbt.fi/'),
  cvp: new Token(
    ChainId.MAINNET,
  ...
  mask: new Token(ChainId.MAINNET, '0x2eD9a5C8C13b93955103B9a7C167B67Ef4d568a3', 18, 'MASK', 'Mask Token', 'https://mask.io/'),
  dvi: new Token(
    ChainId.MAINNET,
  ...
  txl: new Token(ChainId.MAINNET, '0x1FFD0b47127fdd4097E54521C9E2c7f0D66AafC5', 18, 'TXL', 'Tixl Token', 'https://tixl.org/'),
  orbs: new Token(
    ChainId.MAINNET,
  ...
  sxp: new Token(ChainId.MAINNET, '0x47BEAd2563dCBf3bF2c9407fEa4dC236fAbA485A', 18, 'SXP', 'Swipe Token', 'https://swipe.io/'),
  alpha: new Token(
    ChainId.MAINNET,
  ...
  xvs: new Token(ChainId.MAINNET, '0xcF6BB5389c92Bdda8a3747Ddb454cB7a64626C63', 18, 'XVS', 'Venus Token', 'https://venus.io/'),
  sushi: new Token(
    ChainId.MAINNET,
  ...
  oddz: new Token(ChainId.MAINNET, '0xCD40F2670CF58720b694968698A5514e924F742d', 18, 'ODDZ', 'Oddz Token', 'https://oddz.fi/'),
  ...
  cyc: new Token(ChainId.MAINNET, '0x810EE35443639348aDbbC467b33310d2AB43c168', 18, 'CYC', 'CYC Token', 'https://cyclone.xyz/'),
  chr: new Token(
    ChainId.MAINNET,
  ...
  mx: new Token(ChainId.MAINNET, '0x9F882567A62a5560d147d64871776EeA72Df41D3', 18, 'MX', 'MX Token', 'https://www.mxc.com/'),
  ata: new Token(
    ChainId.MAINNET,
  ...
  hai: new Token(ChainId.MAINNET, '0xaA9E582e5751d703F85912903bacADdFed26484C', 8, 'HAI', 'Hacken Token', 'https://hacken.io/'),
  htb: new Token(
    ChainId.MAINNET,
  ...
  htd: new Token(ChainId.MAINNET, '0x5E2689412Fae5c29BD575fbe1d5C1CD1e0622A8f', 18, 'HTD', 'HeroesTD', 'https://heroestd.io/'),
  dpt: new Token(
    ChainId.MAINNET,
  ...
  antex: new Token(ChainId.MAINNET, '0xCA1aCAB14e85F30996aC83c64fF93Ded7586977C', 8, 'ANTEX', 'Antex', 'https://antex.org/'),
  bbt: new Token(
    ChainId.MAINNET,
...
export const testnetTokens = defineTokens({
  ...
  ethk: new Token(65, '0xef71ca2ee68f45b9ad6f72fbdb33d707b872315c', 18, 'ETHK', 'ETHK', 'https://www.okx.com/'),
